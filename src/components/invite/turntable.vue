<template>
  <div class="container h100" style="overflow:auto;">
    ...
    <!-- 弹窗 -->
    <div class="toast toast-self" v-show="toast_control">
    ...
    <div class="toast-mask-between" v-show="toast_control"></div>
  </div>
</template>
<script>
...
export default {
    ...
    created() {
        let hander = setInterval(() => {
            if (!window.WebViewJavascriptBridge) {
                ...
                core
                    .$app("title_info_control", title_info)
                    .then(function(res) {});
    ...
    methods: {
        ...
        share() {
            ...
            let data = {
                shareUrl:
                    wechat.wechat+"/#/lottery?workerID=" +
...
.wheel-bg {
    ...
    height: 33.1rem;
    width: 33.1rem;
    background: url("../../../static/img/draw_wheel.png") no-repeat center
        top;
    background-size: 100%;
    color: #fff;
    font-weight: 500;
...
.toast-mask-between {
    ...
    top: 0;
    left: 0;
    background: url("../../../static/img/photo1.png") no-repeat
        top center;
    background-size: 100%;
    z-index: 10001;
    width: 100%;
...
.close {
    ...
    width: 4rem;
    height: 4rem;
    background: url("../../assets/images/img/invite/fork.png") no-repeat
        center top;
    background-size: 100%;
    transform: translateX(50%);
}
